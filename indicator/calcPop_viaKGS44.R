...
## From PLR to GridCell 
## following calculate_various_rates_per_plr_from_srv.sql - script
## disaggregating the Block-population onto the no of households, and then summing those households to Grid cell


calcPop2Cell <- function( connection, )
  
{
  popPerCell <- dbGetQuery(connection, sprintf( 
